...
const MainBanner = () => {
  return (
    <div className="relative">
      ...
      <h1 className='text-3xl md:text-4xl lg:text-5xl font-bold text-center md:text-left max-w-[18rem] md:max-w-[28rem] lg:max-w-[40rem] leading-tight lg:leading-[3.5rem] tracking-tight antialiased' style={{ color: '#333333' }}>
      ...
      <div className='flex items-center mt-6 font-medium'>
            ...
            <Link to={"/products"} className='group hidden md:flex items-center gap-2 px-9 py-3 cursor-pointer text-base md:text-lg' style={{ color: '#333333' }}>
             Explore deals
