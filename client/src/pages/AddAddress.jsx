...
const AddAddress = () => {
    ...
    const onSubmitHandler = async (e)=>{
        e.preventDefault();
        try {
            // Make sure we're sending the user ID with the address
  ...
  return (
    <div className='mt-16 pb-16'>
        <p className='text-2xl md:text-3xl text-gray-500'>Add Shipping 
            <span style={{ fontWeight: 600, color: 'var(--color-primary)'}}> Address</span></p>
                ...
                <div className='flex-1 max-w-md'>
                    <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
                        ...
                        <div className='grid grid-cols-2 gap-4'>
                            ...
                            <button className="w-full mt-6 text-white py-3 transition cursor-pointer uppercase"
                            style={{backgroundColor: 'var(--color-primary)',}}
                                   onMouseEnter={e => e.currentTarget.style.backgroundColor = 'var(--color-primary-dull)'}
